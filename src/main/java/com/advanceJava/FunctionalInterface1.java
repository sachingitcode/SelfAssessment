...
Note having 2 abstract method wont give complite time error . But it is not counted as func. interface
...
interface sayable{  
  ...
  class says implements sayable{
   public void say(String msg){System.out.println( " say a msg: " + msg );}
   public void doable(){System.out.println( " say a msg again  " );}
}
